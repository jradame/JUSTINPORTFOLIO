  ...
  return (
    <div className="case-study">
          ...
          <div className="overview-card-grid">
            ...
            <div className="overview-card">
              ...
              <div className="overview-card-content">
                <span title="Figma">🎨</span> Figma,{' '}
                <span title="Slides">📊</span> Slides,{' '}
      ...
      <ScrollReveal direction="up" delay={100}>
        <section
          className="case-study__slides"
          style={{ margin: '2.5rem auto', maxWidth: 960 }}
        >
          <iframe
          ...
          <div className="case-study__problem-solution">
            <div className="ps-card ps-card--problem">
              ...
              <p className="section-text">
                Bartenders earn inconsistent income from cash tips, credit tips,
                and mandatory tip-outs, but most still track earnings with
                memory, notes apps, or pen and paper. Without a clear view of
                real take-home pay, it's hard to budget, plan, or see whether
                shifts are truly worth it.
              </p>
            </div>
            ...
            <div className="ps-card ps-card--solution">
              ...
              <p className="section-text">
                TipTrack is a mobile-first app that lets bartenders log a full
                shift in under 30 seconds, automatically calculate tip-outs,
                and instantly see true take-home pay. Clear weekly and monthly
                views help them spot patterns, choose better shifts, and feel
        ...
        <section className="case-study__section">
          ...
          <div className="design-process-grid">
            ...
            <div className="design-card">
              ...
              <p className="section-text">
                Started with quick sketches and low-fidelity wireframes to map
                the core flow: logging a shift, viewing weekly earnings, and
                comparing venues. This made it easy to test navigation, field
                order, and screen hierarchy with bartenders before investing in
                visual design.
              </p>
              <ul className="design-list">
                <li>
                  Focused on a 30-second shift logging flow from first tap to
                  saved entry.
                </li>
                <li>
                  Explored home layouts to surface weekly earnings and trends.
                </li>
                <li>
                  Compared tab vs. bottom navigation for faster access to key
                  screens.
                </li>
              </ul>
              <img
            ...
            <div className="design-card">
              ...
              <p className="section-text">
                Refined the wireframes into a clean, production-ready UI using
                TipTrack branding, clear typography, and a green palette that
                reinforces financial growth. Screens highlight at-a-glance
                earnings, fast shift entry, and simple analytics.
              </p>
              <ul className="design-list">
                ...
                <li>
                  Polished interaction details for buttons, cards, and graphs.
                </li>
              </ul>
              <img
                src="/images/tiptrack-preview.png"
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-description">
                Pre-filled fields and smart defaults reduce entry time from 3+
                minutes to under 30 seconds.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Instant tip-out calculations show real take-home pay,
                eliminating manual math errors.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="feature-description">
                Identify your best earning days and most profitable venues at a
                glance.
              </p>
            </div>
        ...
        <section className="case-study__section">
          <div className="download-card">
            ...
            <p className="download-description">
              Download the complete case study presentation including user
              research, personas, journey maps, competitive analysis, and
